...
public static class DiscordInvite
{
    ...
    /// <summary>The full invite URL for the given application id (null/blank = production).</summary>
    ...
    public static string Url(string? appId) =>
        $"https://discord.com/oauth2/authorize?client_id={(string.IsNullOrWhiteSpace(appId) ? DefaultAppId : appId)}"
